...
namespace SeaBattleLibrary
{
    ...
    {
        public StatusField[,] OwnMap {get; set;}
    ...
    public class Method
    {
        ...
        {
            public const string SetShips = "SetShips";
            public const string Exit = "Exit";
            public const string HitTheEnemy = "HitTheEnemy";
        }

        public class NamesClient
        {
            public const string SetStatus = "SetStatus";
            public const string SetYourMap = "SetYourMap";
            public const string SetEnemyMap = "SetEnemyMap";
